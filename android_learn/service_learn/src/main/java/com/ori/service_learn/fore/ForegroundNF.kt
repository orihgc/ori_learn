...
//初始化前台通知，停止前台通知
class ForegroundNF(private val service: ForeService) : ContextWrapper(service) {
    companion object {
    ...
    private val compatBuilder: NotificationCompat.Builder?
        get() {
            if (mCompatBuilder == null) {
                val notificationIntent = Intent(this, ForeActivity::class.java)
                ...
                //通知内容
                notificationBuilder.setContentText("内容")
                //状态栏显示的小图标
